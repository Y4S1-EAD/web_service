...
namespace web_service.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        {
            newProduct.ProductId = null; // Ensure ProductId is autogenerated
            ...
            try
            {
                ...
                // var vendor = await _vendorService.GetAsync(newProduct.VendorId);
                // if (vendor == null)
                // {
                //     return BadRequest(new { message = "Invalid VendorId: Vendor not found." });
                // }
